<template>
  <div>
    ...
    <p class="mb-6">
      Es tut uns leid, dass Sie gehen. Geben Sie Ihre E-Mail-Adresse ein, um
      sich abzumelden.
    </p>
    ...
    <form @submit.prevent="submitRemovingForm">
      <div>
        ...
        <InputSuccess
          v-if="showRemovingSuccess"
          message="Austragen beantragt."
          class="mt-2"
        />
      </div>
      ...
      <div class="flex items-center justify-center mt-4">
        <PrimaryButton
          :class="{ 'opacity-25': removingForm.processing }"
