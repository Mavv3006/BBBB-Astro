<template>
  ...
  <li v-if="!element.link && element.submenu" class="nav-container">
    <span>{{ element.linkName }}</span>
    <ul class="dropdown-content hidden absolute bg-red-600 py-2 z-10 shadow-md -ml-4 rounded-md min-w-28">
