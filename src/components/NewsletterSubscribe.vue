  ...
  <div>
    ...
    <Accordion title="Wie funktioniert der Anmeldeprozess?">
      <div class="bg-gray-50 rounded-lg p-4">
        <ol class="list-decimal list-inside space-y-2 text-gray-600">
          ...
          <li>
            Klicken Sie auf den Verifizierungslink in der E-Mail, um Ihre
    ...
    <form @submit.prevent="submitAddingForm">
      <div>
        ...
        <InputSuccess
          v-if="showAddingSuccess"
          class="mt-2"
          message="Eintragen beantragt."
        />
      </div>
      ...
      <div class="flex gap-x-2 flex-row mt-4">
        <input
          ...
          required
          type="checkbox"
          v-model="addingForm.data_privacy_consent"
        />
        <InputLabel for="data-privacy-consent"
          >Ich habe die
          <NavLink href="/datenschutz">Datenschutzerklärung</NavLink>
          gelesen und stimme der Verarbeitung meiner Daten gemäß dieser zu. Ich
          erhalte den Newsletter mit Informationen zu unseren kommenden
          Auftritten.
        </InputLabel>
      </div>
      ...
      <div class="flex items-center justify-center mt-4">
        <PrimaryButton
          :class="{ 'opacity-25': addingForm.processing }"
...
const addingForm = useForm<NewsletterRequestType>({
  ...
  data_privacy_consent_text:
    "Ich habe die Datenschutzerklärung gelesen und stimme der Verarbeitung meiner Daten gemäß dieser zu. Ich erhalte den Newsletter mit Informationen zu unseren kommenden Auftritten.",
});
